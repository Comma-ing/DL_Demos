...
class PositionalEncoding(nn.Module):
    ...
    def __init__(self, max_seq_len, d_model) -> None:
        ...
        pe_2i = torch.sin(pos / 10000**(i / d_model))
        pe_2i_1 = torch.cos(pos / 10000**(i / d_model))
...
class ResidualBlock(nn.Module):
    ...
    def __init__(self, in_c: int, out_c: int) -> None:
        ...
        self.relu1 = nn.ReLU()
        self.cov2 = nn.Conv2d(out_c, out_c, 3, 1, 1)
        self.bn2 = nn.BatchNorm2d(out_c)
        self.relu2 = nn.ReLU()
        if in_c != out_c:
            self.shortcut = nn.Sequential(nn.Conv2d(in_c, out_c, 3, 1, 1),
